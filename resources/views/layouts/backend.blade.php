                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="{{ request()->is('posts/*') ? ' open' : '' }}">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-bulb"></i><span class="sidebar-mini-hide">Posts</span></a>
                                <ul>
                                    <li>
                                        <a class="{{ request()->is('posts') ? ' active' : '' }}" href="/posts">List</a>
                                    </li>
                                    <li>
                                        <a class="{{ request()->is('posts/create') ? ' active' : '' }}" href="/posts/create">Create</a>
                                    </li>
                                </ul>
                            </li>
